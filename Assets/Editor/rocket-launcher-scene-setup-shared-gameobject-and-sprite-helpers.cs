...
public partial class SceneSetupTool
{
    ...
    private static Sprite CreateOrLoadSpriteAsset(string name, bool isCircle)
    {
        ...
        // Delete old asset to avoid stale references
        ...
        // Save texture as .asset file (bypasses PNG import pipeline entirely)
        AssetDatabase.CreateAsset(tex, assetPath);

        // Create sprite from saved texture, add as sub-asset so it serializes properly
        ...
        // Load the sprite back from the asset to get a persistent reference
